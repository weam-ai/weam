...
const {formatAIMessage, formatAIMessageResponse, formatUser, encryptedData, getCompanyId, decryptedData, isSubscriptionActive, isSubscriptionFinished } = require('../utils/helper');
